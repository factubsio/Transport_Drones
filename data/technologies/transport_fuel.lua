...
local advanced_coal_to_fuel =
{
  ...
  type = "technology",
  icon = util.path("data/technologies/transport-fuel-coal-2.png"),
  icon_size = 128,
  upgrade = true,
  effects =
  {
...
local gas_to_fuel =
{
  ...
  type = "technology",
  icon = util.path("data/technologies/transport-fuel-gas.png"),
  icon_size = 128,
  upgrade = true,
  effects =
  {
...
local rocket_fuel_to_fuel =
{
  ...
  type = "technology",
  icon = util.path("data/technologies/transport-fuel-rocket-fuel.png"),
  icon_size = 128,
  upgrade = true,
  effects =
  {
